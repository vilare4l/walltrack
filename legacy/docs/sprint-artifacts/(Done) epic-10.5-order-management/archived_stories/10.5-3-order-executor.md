...
- [x] Create OrderExecutor class
- [x] Implement _execute_real with Jupiter integration
- [x] Implement _execute_simulated for simulation mode
- [x] Implement quote fetching from Jupiter
- [x] Implement transaction creation and signing
- [x] Implement confirmation waiting with timeout
- [x] Implement actual price extraction
- [x] Add concurrency control with semaphore
- [x] Create MockOrderExecutor for testing
- [x] Add structured logging throughout
- [x] Write unit tests with mocked Jupiter
- [x] Write integration tests

## Definition of Done

- [x] Orders execute through full lifecycle
- [x] Jupiter API errors are caught and retried
- [x] Simulation mode works without real transactions
- [x] Concurrency is controlled
- [x] All transitions are persisted
