...
- [x] Create OrderPriority enum
- [x] Create PrioritizedOrder wrapper
- [x] Implement OrderPriorityQueue with heap
- [x] Add concurrency control
- [x] Create QueuedOrderExecutor
- [x] Integrate with Entry/Exit services
- [x] Add emergency override support
- [x] Create Gradio queue_monitor panel
...
- [x] Stop loss exits have highest priority
- [x] Emergency flag provides absolute priority
- [x] Concurrency limited to configured max
- [x] Metrics tracked (wait time, throughput)
- [x] Gradio shows queue status
