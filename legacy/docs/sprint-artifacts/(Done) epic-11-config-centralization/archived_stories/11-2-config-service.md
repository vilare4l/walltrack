...
- [x] Create ConfigService class
- [x] Implement TTL cache with cachetools
- [x] Create Pydantic models for each config table
- [x] Implement get() with key parsing
- [x] Implement get_block() for full table fetch
- [x] Add fallback defaults for all tables
- [x] Implement refresh() for cache invalidation
- [x] Add typed helper methods (get_trading_config, etc.)
- [x] Create singleton pattern
- [x] Write unit tests with mocked DB
- [x] Write integration tests

## Definition of Done

- [x] All config tables accessible via service
- [x] Cache working with 60s TTL
- [x] Fallback to defaults when DB unavailable
- [x] Force refresh works
- [x] Pydantic models validate data
