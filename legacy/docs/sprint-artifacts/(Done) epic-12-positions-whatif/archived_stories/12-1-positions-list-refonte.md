...
- [x] Create PositionsListComponent class
- [x] Implement get_active_positions() with strategy join
- [x] Implement get_closed_positions() with exit details
- [x] Format tables with P&L coloring
- [x] Add action buttons (Details, Strategy, What-If)
- [x] Implement row selection handling
- [x] Add refresh functionality
- [x] Connect to sidebar/modal callbacks
- [x] Write tests

## Definition of Done

- [x] Active positions display with all fields
- [x] Closed positions display with exit type
- [x] P&L colored correctly
- [x] Actions trigger correct callbacks
