...
- [x] Create create_price_chart() function
- [x] Add price line with hover info
- [x] Add entry point marker
- [x] Add actual exit markers
- [x] Add simulated exit markers with colors
- [x] Add strategy level lines
- [x] Create create_comparison_chart()
- [x] Create create_mini_chart() for cards
- [x] Configure responsive layout
- [x] Test with Gradio gr.Plot
- [x] Write tests

## Definition of Done

- [x] Price chart displays correctly
- [x] Entry point visible
- [x] Exit points marked correctly
- [x] Simulated exits in different colors
- [x] Tooltips show details
- [x] Chart is responsive
- [x] Mini chart works for cards
