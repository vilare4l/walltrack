...
- [x] Check limit before trade execution
- [x] Block trades at max limit
- [x] Queue signals when limit reached
- [x] Execute pending signals on position close (FIFO)
- [x] Make limit configurable via dashboard

## Definition of Done

- [x] Position limit enforced correctly
- [x] Trades blocked at max limit
- [x] Pending signals execute on close
- [x] Limit adjustable via dashboard
...
- `src/walltrack/core/risk/position_limits.py` - PositionLimitManager class
- `src/walltrack/models/risk.py` - Models (PositionLimitConfig, QueuedSignal, PositionRequestResult, QueueStatus)
- `src/walltrack/data/supabase/migrations/010_risk_management.sql` - queued_signals, position_slot_events tables
- `tests/unit/risk/test_position_limits.py` - 20 unit tests
