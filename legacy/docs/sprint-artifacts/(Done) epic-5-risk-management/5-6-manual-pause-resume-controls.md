...
- [x] Create `src/walltrack/core/risk/system_state.py`
- [x] Implement pause with confirmation dialog
- [x] Implement resume with warning for circuit breakers
- [x] Ensure exits continue during pause
- [x] Store pause/resume history with reasons
- [x] Add API routes for controls

## Definition of Done

- [x] Manual pause blocks new trades
- [x] Resume restores normal operation
- [x] Exits continue during pause
- [x] Pause reasons recorded
...
- `src/walltrack/core/risk/system_state.py` - SystemStateManager class
- `src/walltrack/api/routes/system.py` - API routes (GET /system/state, POST /system/pause, POST /system/resume)
- `src/walltrack/models/risk.py` - Models (PauseReason, SystemState, PauseRequest, ResumeRequest, PauseResumeEvent)
- `src/walltrack/data/supabase/migrations/010_risk_management.sql` - pause_resume_events table
- `tests/unit/risk/test_system_state.py` - 25 unit tests
