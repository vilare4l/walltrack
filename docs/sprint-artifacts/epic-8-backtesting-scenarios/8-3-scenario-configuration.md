...
- [ ] Create Scenario model with validation
- [ ] Create preset scenarios
- [ ] Implement ScenarioService CRUD operations
- [ ] Add backtest_scenarios table
- [ ] Implement scenario export/import
- [ ] Implement comparison to live config
- [ ] Write unit tests

## Definition of Done

- [ ] Scenarios can be created, updated, deleted
- [ ] Preset scenarios are available
- [ ] Scenarios can be duplicated
