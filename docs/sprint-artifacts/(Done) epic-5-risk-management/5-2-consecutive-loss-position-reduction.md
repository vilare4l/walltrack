...
- [x] Create `src/walltrack/core/risk/consecutive_loss.py`
- [x] Track consecutive loss count
- [x] Implement position size reduction at threshold
- [x] Reset on profitable trade
- [x] Implement critical threshold handling
- [x] Log all reductions and recoveries

## Definition of Done

- [x] Consecutive losses tracked correctly
- [x] Position size reduced at threshold
- [x] Recovery resets to normal sizing
- [x] Critical threshold alerts operator
...
- `src/walltrack/core/risk/consecutive_loss.py` - ConsecutiveLossManager class
- `src/walltrack/models/risk.py` - Models (TradeOutcome, SizingMode, ConsecutiveLossConfig, ConsecutiveLossState)
- `src/walltrack/data/supabase/migrations/010_risk_management.sql` - loss_streak_events table
- `tests/unit/risk/test_consecutive_loss.py` - 18 unit tests
