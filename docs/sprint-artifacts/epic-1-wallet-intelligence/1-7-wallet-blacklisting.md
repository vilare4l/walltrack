...
- [ ] Create `src/walltrack/core/blacklist_service.py`
- [ ] Create `src/walltrack/data/supabase/migrations/004_blacklist_history.sql`
- [ ] Create `src/walltrack/data/supabase/repositories/blacklist_history_repo.py`
- [ ] Create `src/walltrack/api/routes/blacklist.py`
- [ ] Create `src/walltrack/core/signal_filter.py`
- [ ] Update wallet routes with blacklist endpoints
- [ ] Implement blacklist check in signal processing pipeline
- [ ] Write unit tests
- [ ] Write integration tests

## Definition of Done

- [ ] Wallets can be blacklisted via API/dashboard
- [ ] Blacklisted wallets excluded from signal processing
- [ ] Signals from blacklisted wallets logged but not scored
- [ ] Blacklist can be removed
- [ ] Blacklist history is maintained
- [ ] All unit tests pass
- [ ] mypy and ruff pass
