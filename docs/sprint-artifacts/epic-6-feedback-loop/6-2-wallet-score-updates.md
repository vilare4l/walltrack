...
- [ ] Create `src/walltrack/core/feedback/score_updater.py`
- [ ] Implement score update on trade outcome
- [ ] Weight updates by profit/loss magnitude
- [ ] Connect to decay detection (Story 1.6)
- [ ] Bound scores between 0.0 and 1.0
- [ ] Preserve score history
- [ ] Handle batch updates efficiently

## Definition of Done

- [ ] Wallet scores updated on trade outcomes
- [ ] Profitable trades increase score
- [ ] Losses decrease score and trigger flagging
