...
- [ ] Create `src/walltrack/core/feedback/trade_recorder.py`
- [ ] Record full trade details on position close
- [ ] Handle partial exits with linking
- [ ] Update aggregate metrics on trade record
- [ ] Ensure query performance for 1 year data
- [ ] Link trades to signals and positions

## Definition of Done

- [ ] Trade outcomes recorded with full details
- [ ] Partial exits linked to parent position
- [ ] Aggregate metrics updated automatically
