...
- [ ] Create `src/walltrack/ui/components/config_panel.py`
- [ ] Display all scoring weights and threshold
- [ ] Implement weight adjustment with validation
...
- [ ] Scoring weights viewable and editable
- [ ] Threshold adjustable with validation
- [ ] Changes take effect immediately
