...
- [ ] Create threshold application module
- [ ] Implement configurable threshold (default 0.70)
- [ ] Mark signals as trade_eligible or below_threshold
- [ ] Log eligibility with score details
- [ ] Define position sizing tiers
- [ ] Store threshold in Supabase config

## Definition of Done

- [ ] Threshold check filters signals correctly
- [ ] Trade-eligible signals proceed to execution
- [ ] Below-threshold signals logged but not executed
- [ ] Threshold configurable via dashboard
