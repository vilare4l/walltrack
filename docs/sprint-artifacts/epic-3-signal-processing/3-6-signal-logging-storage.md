...
- [ ] Create signals table schema in Supabase
- [ ] Create `src/walltrack/data/supabase/repositories/signal_repo.py`
- [ ] Implement async signal storage
...
- [ ] All signals stored in Supabase
- [ ] Query by date, wallet, score, status works
- [ ] Performance acceptable for 6 months data
- [ ] Async logging doesn't block pipeline
