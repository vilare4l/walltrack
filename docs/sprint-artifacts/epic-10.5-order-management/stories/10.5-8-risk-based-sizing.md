...
- [ ] Refactor PositionSizer with SizingMode
- [ ] Implement risk-based calculation formula
- [ ] Implement fixed-percent (legacy) mode
- [ ] Add conviction multiplier support
- [ ] Add min/max bounds with logging
- [ ] Integrate with ConfigService for hot-reload
- [ ] Create Gradio sizing config panel
- [ ] Add sizing calculator preview (show example sizes)
- [ ] Write unit tests for both modes
- [ ] Write integration tests with config changes

## Definition of Done

- [ ] Risk-based sizing calculates correctly
- [ ] SL distance affects position size inversely
- [ ] Conviction multiplier applied correctly
- [ ] Min/max bounds respected
- [ ] Mode switchable via config
