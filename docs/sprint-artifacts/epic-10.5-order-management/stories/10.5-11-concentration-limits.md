...
- [ ] Create ConcentrationChecker class
- [ ] Implement token concentration calculation
- [ ] Implement cluster concentration calculation
- [ ] Check for existing position on same token
- [ ] Integrate with PositionSizer for size adjustment
- [ ] Integrate with RiskManager for entry blocking
- [ ] Create Gradio portfolio_allocation panel
- [ ] Add status indicators (OK/WARNING/LIMIT)
- [ ] Write unit tests
- [ ] Write integration tests

## Definition of Done

- [ ] Token concentration limits enforced
- [ ] Cluster concentration limits enforced
- [ ] Max positions per cluster checked
- [ ] No duplicate positions on same token
- [ ] Sizes adjusted when approaching limits
- [ ] Entries blocked when at limits
- [ ] Gradio shows clear allocation view
- [ ] Full test coverage
