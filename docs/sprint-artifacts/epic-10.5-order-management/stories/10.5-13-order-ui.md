...
- [ ] Build orders data table
- [ ] Implement order detail view
- [ ] Create timeline display from audit log
- [ ] Add cancel order action
- [ ] Add retry now action
- [ ] Set up auto-refresh (every 5s)
- [ ] Create order status log table
- [ ] Add status change trigger
- [ ] Write unit tests
- [ ] Write E2E tests

## Definition of Done

- [ ] Orders listed with all columns
...
### New Files
- `src/walltrack/ui/pages/orders.py` - Orders page
- `src/walltrack/ui/components/order_card.py` - Order card component
- `tests/unit/ui/test_orders_page.py` - Page tests
- `tests/e2e/test_orders_flow.py` - E2E tests

### Modified Files
- `migrations/V9__orders.sql` - Add status log table
- `src/walltrack/ui/app.py` - Register orders page
