...
- [ ] Create EntryOrderService class
- [ ] Integrate with RiskManager for entry checks
- [ ] Integrate with PriceOracle for current price
- [ ] Create position from filled order
- [ ] Assign exit strategy based on signal score
- [ ] Update signal status on success/failure
- [ ] Create failure alerts
- [ ] Modify signal pipeline to use order flow
- [ ] Add Gradio signal detail with order status
- [ ] Write unit tests
- [ ] Write integration tests

## Definition of Done

- [ ] Signals create Orders instead of Positions directly
- [ ] Positions created only when Order is FILLED
- [ ] Risk checks block entries when appropriate
- [ ] Failed entries create alerts
- [ ] Signal status reflects order outcome
- [ ] Gradio shows order status for signals
- [ ] Full test coverage
