...
- [ ] Create PriceOracle class
- [ ] Implement DexScreenerProvider
- [ ] Implement BirdeyeProvider
- [ ] Implement JupiterPriceProvider
- [ ] Add TTL caching with cachetools
- [ ] Implement batch price fetching
- [ ] Add source failure cooldown
- [ ] Add price validation
- [ ] Create price display Gradio component
- [ ] Write unit tests with mocked providers
- [ ] Write integration tests

## Definition of Done

- [ ] Prices fetched from DexScreener first
- [ ] Automatic fallback to Birdeye/Jupiter
- [ ] Cache prevents redundant API calls
- [ ] Batch fetching works efficiently
- [ ] Failed sources enter cooldown
- [ ] Gradio shows price with source
- [ ] Full test coverage
