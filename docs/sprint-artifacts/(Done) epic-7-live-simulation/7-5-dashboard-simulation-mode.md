...
- [x] Create simulation_dashboard.py component
- [x] Create mode_indicator.py component
- [x] Implement positions table with P&L
- [ ] Implement P&L chart with history
- [x] Add trade history tab
...
- [x] Simulation banner clearly visible
- [x] All data labeled as simulated
- [x] Real-time P&L updates work (via refresh button)
...
- Created `mode_indicator.py` with dynamic HTML badge (red for simulation, green for live)
- Created `simulation_dashboard.py` with:
  - Prominent simulation banner
  - Summary metrics (Total P&L, Unrealized, Realized, Position count)
  - Positions table with real-time P&L calculation
  - Stale price warning indicator
  - Trade history tab placeholder
  - Manual refresh button

### Tests Created
- `tests/unit/ui/components/test_simulation_dashboard.py` - 6 tests covering:
  - Mode indicator HTML for simulation mode
  - Mode indicator HTML for live mode
  - Simulation banner creation
  - Portfolio summary data
  - Position data formatting
  - Stale price indication

## File List

### New Files
- `src/walltrack/ui/components/mode_indicator.py` - Mode indicator badge
- `src/walltrack/ui/components/simulation_dashboard.py` - Simulation dashboard panel
- `tests/unit/ui/components/test_simulation_dashboard.py` - Unit tests

## Change Log

- 2025-12-21: Story 7-5 implementation complete - Dashboard simulation mode components
