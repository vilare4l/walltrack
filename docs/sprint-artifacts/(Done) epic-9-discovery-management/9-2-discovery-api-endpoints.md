...
- [x] Create discovery router with all endpoints
- [x] Implement trigger endpoint with background execution
- [x] Implement run status endpoint
- [x] Implement runs list with pagination
- [x] Implement stats endpoint
- [x] Implement config get/update endpoints
...
- [x] Discovery runs in background
- [x] Pagination works correctly
- [x] Stats are calculated accurately
- [x] Config can be updated
- [x] API tests pass

## Dev Agent Record

### Implementation Notes (2024-12-24)
- Created `discovery.py` router with 6 endpoints
- POST `/discovery/run` - trigger discovery with background execution
- GET `/discovery/runs/{run_id}` - get run details
- GET `/discovery/runs` - list runs with pagination and filters
- GET `/discovery/stats` - aggregated statistics
- GET/PUT `/discovery/config` - scheduler configuration
...
### New Files
- `src/walltrack/api/routes/discovery.py` - API endpoints with 6 routes
- `tests/unit/api/routes/test_discovery.py` - 16 API tests

### Modified Files
- `src/walltrack/api/app.py` - Register discovery router
