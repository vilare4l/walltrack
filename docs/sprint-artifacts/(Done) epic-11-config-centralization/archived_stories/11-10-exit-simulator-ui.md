...
- [x] Create ExitSimulatorPage class
- [x] Implement single simulation UI
- [x] Build timeline chart visualization
- [x] Implement strategy comparison UI
- [x] Build comparison chart
- [x] Implement batch simulation UI
- [x] Implement what-if analysis UI
- [x] Add position and strategy selectors
- [x] Connect to simulation engine
- [x] Add to main navigation

## Definition of Done

- [x] Single simulation displays results
- [x] Timeline chart shows triggers
- [x] Strategy comparison works
- [x] Batch simulation calculates stats
- [x] What-if shows projected outcomes
