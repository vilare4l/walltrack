...
- [x] Create `src/walltrack/discovery/decay_detector.py`
- [x] Create `src/walltrack/data/supabase/migrations/003_decay_events.sql`
- [x] Create `src/walltrack/data/supabase/repositories/decay_event_repo.py`
- [x] Implement rolling window calculation
- [x] Implement decay threshold detection
- [x] Add flagging mechanism
- [x] Implement consecutive loss tracking
- [x] Add recovery detection
- [x] Create `src/walltrack/scheduler/tasks/decay_check_task.py`
- [x] Create `src/walltrack/api/routes/decay.py`
- [x] Write unit tests

## Definition of Done

- [x] Decay detection identifies underperforming wallets
- [x] Wallets flagged when threshold breached
- [x] Recovery clears flags appropriately
- [x] Periodic checks run on schedule
...
### Files Created
- `src/walltrack/discovery/decay_detector.py` - DecayDetector with DecayEvent dataclass
- `src/walltrack/data/supabase/repositories/decay_event_repo.py` - DecayEventRepository
- `src/walltrack/scheduler/tasks/decay_check_task.py` - Scheduled decay checking task

### Tests
- `tests/unit/discovery/test_decay_detector.py` - 18 tests for decay detection
- Tests cover: decay detection, consecutive losses, recovery, batch checking

### Key Implementation Details
- DecayEvent types: "decay_detected", "consecutive_losses", "recovered"
- Configurable thresholds: win_rate_threshold (0.40), consecutive_loss_threshold (3), rolling_window (20)
- Rolling window calculation for recent performance tracking
- Auto-recovery when wallet rebounds above threshold
- Batch checking with check_all_wallets() for scheduled tasks
- Events stored in decay_events table with severity levels
