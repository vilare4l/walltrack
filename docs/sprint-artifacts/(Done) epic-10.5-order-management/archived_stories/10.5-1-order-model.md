...
- [x] Create `src/walltrack/models/order.py` with Order model
- [x] Implement OrderStatus enum with all states
- [x] Implement state machine with transition validation
- [x] Create OrderTransitionError exception
- [x] Implement retry logic with exponential backoff
- [x] Create OrderFactory for order creation
- [x] Create OrderCreateRequest/OrderSummary DTOs
...
- [x] Order model handles all states correctly
- [x] Invalid state transitions raise exception
- [x] Retry backoff is calculated correctly
- [x] Factory creates orders from signals and positions
- [x] Simulation mode flag is preserved
- [x] 100% test coverage on state machine
