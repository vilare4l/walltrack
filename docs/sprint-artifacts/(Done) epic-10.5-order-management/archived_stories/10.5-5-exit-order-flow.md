...
- [x] Create ExitOrderService class
- [x] Implement create_exit_order with partial exit support
- [x] Implement execute_exit_order with position update
- [x] Calculate PnL on each exit
- [x] Create critical alerts for failed exits
- [x] Implement retry_failed_exit for manual recovery
- [x] Modify ExitManager to use order flow
- [ ] Add priority queue for exit orders (Story 10.5.15)
- [x] Add Gradio exit controls with order status
- [x] Write unit tests
- [x] Write integration tests

## Definition of Done

- [x] All exits go through order flow
- [x] Partial exits update position correctly
- [x] Full exits close position
- [x] Failed exits create critical alerts
- [x] Manual retry works from UI
- [x] PnL calculated correctly on each exit
