...
- [x] Create DrawdownCalculator class
- [x] Add portfolio_snapshots query
- [x] Create SizeReductionApplicator (integrated into PositionSizer)
- [x] Parse drawdown_reduction_tiers from config
- [x] Find and apply active tier
- [x] Integrate with PositionSizer
- [x] Handle 100% reduction (trading blocked)
- [ ] Create Gradio risk_status panel (deferred to Story 10.5-13)
- [ ] Add auto-refresh for risk status (deferred to Story 10.5-13)
- [x] Write unit tests

## Definition of Done

- [x] Drawdown calculated from portfolio snapshots
- [x] Correct tier selected based on drawdown %
- [x] Size reduced progressively with tiers
- [x] Trading blocked at 100% reduction tier
- [x] Recovery restores normal sizing
- [ ] Gradio shows current risk status (deferred to Story 10.5-13)
