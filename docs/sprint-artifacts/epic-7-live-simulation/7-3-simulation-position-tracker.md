...
- [ ] Extend Position model with simulated field
- [ ] Create PositionService with simulation filtering
- [ ] Add database migration for simulated column
- [ ] Implement position creation with mode awareness
- [ ] Implement position closing with P&L
- [ ] Add position monitoring integration
- [ ] Write unit tests

## Definition of Done

- [ ] Positions are created with correct simulated flag
- [ ] Active positions query respects simulation filter
- [ ] Position monitoring works with real prices
- [ ] Mode switching preserves positions
