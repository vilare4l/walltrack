...
- [ ] Create SimulationPnLCalculator class
- [ ] Implement price caching with TTL
- [ ] Implement portfolio P&L calculation
- [ ] Create pnl_history table and logging
- [ ] Handle stale price scenarios
- [ ] Add scheduled P&L refresh job
- [ ] Write unit tests

## Definition of Done

- [ ] P&L calculates correctly for all positions
- [ ] Price caching reduces API calls
- [ ] Stale prices are clearly indicated
- [ ] P&L history is logged periodically
