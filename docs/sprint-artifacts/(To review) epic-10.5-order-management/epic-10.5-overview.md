...
|-------|--------|----------|--------|
| 10.5-1: Order Model | 5 | P0 | ✅ Done |
| 10.5-2: Order Table | 3 | P0 | ✅ Done |
| 10.5-3: Order Executor | 8 | P0 | ✅ Done |
| 10.5-4: Entry Order Flow | 5 | P0 | ✅ Done |
| 10.5-5: Exit Order Flow | 5 | P0 | ✅ Done |
| 10.5-6: Price Oracle | 5 | P0 | ✅ Done |
| 10.5-7: Price History | 5 | P1 | ✅ Done |
| 10.5-8: Risk-Based Sizing | 5 | P0 | ✅ Done |
| 10.5-9: Drawdown Reduction | 3 | P1 | ✅ Done |
| 10.5-10: Daily Loss Limit | 3 | P1 | ✅ Done |
| 10.5-11: Concentration Limits | 3 | P2 | ✅ Done |
| 10.5-12: Retry Worker | 5 | P0 | ✅ Done |
| 10.5-13: Order UI | 5 | P1 | ✅ Done |
| 10.5-14: Alerts | 3 | P1 | ✅ Done |
| 10.5-15: Priority Queue | 3 | P2 | ✅ Done |
| **Total** | **66** | | **15/15** |
...
- [x] Table `orders` créée et migrée
- [x] Order state machine avec transitions validées
- [x] Entry flow passe par Order
- [x] Exit flow passe par Order
- [x] Retry automatique avec backoff
- [x] Price Oracle multi-source fonctionnel
- [x] Risk-based sizing implémenté
- [x] Daily loss limit fonctionnel
- [x] Simulation suit le même flow (MockExecutor)
- [x] UI pour visualiser les ordres
- [x] Alertes sur échecs critiques
