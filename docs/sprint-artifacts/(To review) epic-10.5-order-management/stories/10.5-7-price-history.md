...
- [x] Create V10 migration for price_history tables
- [x] Create partitioned table structure
- [x] Create compressed history table
- [x] Create position metrics table
- [x] Implement PriceCollector service
- [x] Implement batch collection
- [x] Implement peak/trough tracking
- [x] Implement PriceHistoryCompressor
- [x] Implement PriceHistoryCleanup
- [x] Create PriceHistoryRepository
- [x] Add scheduler jobs for compression/cleanup
- [x] Write tests

## Definition of Done

- [x] Prices collected every 5 seconds for active positions
- [x] Batch API calls minimize external requests
- [x] Peak/drawdown metrics updated in real-time
- [x] Old data compressed to 1-minute OHLC
- [x] Closed position data cleaned after 7 days
