...
- [ ] Create `src/walltrack/models/trade.py` with all trade models
- [ ] Create `src/walltrack/config/jupiter_settings.py`
- [ ] Create `src/walltrack/constants/solana.py`
- [ ] Create `src/walltrack/services/jupiter/client.py`
- [ ] Implement Jupiter V6 quote API client
- [ ] Implement swap transaction building
- [ ] Add transaction submission and confirmation
- [ ] Create `src/walltrack/services/raydium/client.py` for fallback
- [ ] Create `src/walltrack/services/trade/executor.py`
- [ ] Create `src/walltrack/api/routes/trade.py`
- [ ] Add database migrations for trades
- [ ] Write comprehensive unit tests

## Definition of Done

- [ ] Jupiter swaps execute successfully
- [ ] Slippage tolerance configurable (default 1%)
- [ ] Fallback to Raydium works on Jupiter failure
- [ ] Execution latency tracked (target < 5s)
- [ ] All trade results logged with tx signature
- [ ] Retry logic with exponential backoff
