...
- [ ] Migrate SignalScorer to use ConfigService
- [ ] Migrate ThresholdChecker to use ConfigService
- [ ] Migrate SignalFilter to use ConfigService
- [ ] Migrate SignalAmplifier to use ConfigService
- [ ] Migrate SyncDetector to use ConfigService
- [ ] Migrate LeaderDetection to use ConfigService
- [ ] Migrate DecayDetector to use ConfigService
- [ ] Migrate PumpFinder to use ConfigService
- [ ] Migrate Profiler to use ConfigService
- [ ] Remove or deprecate constants files
- [ ] Update all service instantiation points
- [ ] Write tests for migrated components

## Definition of Done

- [ ] All 10 components migrated
- [ ] No hardcoded thresholds (except fallbacks)
- [ ] Constants files removed/deprecated
- [ ] All tests passing
- [ ] No grep hits for magic numbers
