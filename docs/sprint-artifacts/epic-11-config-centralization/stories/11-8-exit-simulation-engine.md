...
- [ ] Create SimulationResult dataclass
- [ ] Create AggregateStats dataclass
- [ ] Create StrategyComparison dataclass
- [ ] Implement ExitSimulationEngine class
- [ ] Implement simulate_position() method
- [ ] Implement _simulate_on_prices() core logic
- [ ] Implement _check_rule() for all rule types
- [ ] Implement batch_simulate() method
- [ ] Implement compare_strategies() method
- [ ] Create WhatIfCalculator class
- [ ] Write unit tests with mock price data
- [ ] Write integration tests

## Definition of Done

- [ ] Single position simulation works
- [ ] All rule types properly evaluated
- [ ] Batch simulation calculates correct stats
- [ ] Strategy comparison identifies best
- [ ] What-if analysis generates scenarios
