...
- [ ] Create ConvictionTier enum/class
- [ ] Create ExitStrategyAssigner class
- [ ] Implement determine_conviction_tier()
- [ ] Implement get_default_strategy_id()
- [ ] Implement get_strategy_for_position()
- [ ] Implement assign_strategy_to_position()
- [ ] Implement change_position_strategy()
- [ ] Add exit_strategy_id to positions table
- [ ] Add default strategy columns to exit_config
- [ ] Integrate with position creation flow
- [ ] Create UI selector component
- [ ] Write unit tests

## Definition of Done

- [ ] Auto-assignment works for standard tier
- [ ] Auto-assignment works for high conviction
- [ ] Manual override takes precedence
- [ ] Fallback works when strategy missing
- [ ] Position update changes strategy
