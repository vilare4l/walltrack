...
- [ ] Create config page layout with tabs
- [ ] Create trading config tab
- [ ] Create scoring config tab
- [ ] Create discovery config tab
- [ ] Create cluster config tab
- [ ] Create risk config tab
- [ ] Create exit config tab
- [ ] Create API config tab
- [ ] Implement load_config handler
- [ ] Implement edit mode toggle
- [ ] Implement save draft handler
- [ ] Implement activate handler
- [ ] Implement discard handler
