...
- [ ] Implement GET /{table} endpoint
- [ ] Implement GET /{table}/all endpoint
- [ ] Implement POST /{table}/draft endpoint
- [ ] Implement PATCH /{table}/draft endpoint
- [ ] Implement POST /{table}/activate endpoint
- [ ] Implement POST /{table}/{id}/restore endpoint
- [ ] Implement GET /audit endpoint
- [ ] Add audit logging helper
- [ ] Wire router to FastAPI app
- [ ] Write API tests
