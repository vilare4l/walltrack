...
- [ ] Create ExitStrategiesPage class
- [ ] Implement strategies list view
- [ ] Implement strategy selection and loading
- [ ] Build rule editor with JSON input
- [ ] Add form validation
- [ ] Implement create/update handlers
- [ ] Implement activate/clone/delete handlers
- [ ] Add strategy preview chart
- [ ] Create from template functionality
- [ ] Add to main navigation

## Definition of Done

- [ ] All strategies display in list
- [ ] Create new strategy works
- [ ] Edit existing strategy works
- [ ] Rule editor validates JSON
- [ ] Preview shows exit levels
- [ ] Clone creates copy
- [ ] Delete removes drafts only
