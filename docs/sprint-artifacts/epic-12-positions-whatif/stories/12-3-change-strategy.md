...
- [ ] Create ChangeStrategyModal class
- [ ] Implement get_available_strategies()
- [ ] Implement calculate_preview()
- [ ] Implement apply_strategy_change()
- [ ] Create position_events table migration
- [ ] Log strategy changes
- [ ] Build modal UI
- [ ] Add preview on strategy select
- [ ] Handle executed exits preservation
- [ ] Write tests

## Definition of Done

- [ ] Modal opens with current strategy
- [ ] Dropdown shows all active strategies
- [ ] Preview shows calculated levels
- [ ] Confirm changes strategy
- [ ] Event is logged
- [ ] Executed exits preserved
- [ ] Tests passing
