...
- [ ] Create PositionDetailsSidebar class
- [ ] Implement get_position_details() with joins
- [ ] Implement render_active_position()
- [ ] Implement render_closed_position()
- [ ] Calculate next TP level
- [ ] Show reached/not reached levels
- [ ] Build sidebar UI component
- [ ] Add open/close functionality
- [ ] Connect What-If and Strategy buttons
- [ ] Write tests

## Definition of Done

- [ ] Sidebar opens with position details
- [ ] Active positions show correct content
- [ ] Closed positions show correct content
- [ ] Strategy levels show status
- [ ] What-If button visible for closed
