...
- [ ] Create WhatIfModal class
- [ ] Implement get_position() with details
- [ ] Implement get_strategies_choices()
- [ ] Implement run_comparison() with chart
- [ ] Implement set_as_default()
- [ ] Build modal UI with Gradio
- [ ] Add strategy checkboxes
- [ ] Display comparison results
- [ ] Show chart with exit points
...
- [ ] Modal opens with position info
- [ ] Strategies selectable via checkboxes
- [ ] Simulation runs and shows results
- [ ] Chart displays exit points
