...
- [ ] Create StrategyComparisonRow dataclass
- [ ] Create ComparisonResult dataclass
- [ ] Implement StrategyComparator class
- [ ] Implement compare() method
- [ ] Implement compare_all_active_strategies()
- [ ] Calculate delta vs actual
...
- [ ] Comparison runs for multiple strategies
- [ ] Delta calculated correctly
- [ ] Best strategy identified
- [ ] Table formatted with colors
- [ ] Tests pass
