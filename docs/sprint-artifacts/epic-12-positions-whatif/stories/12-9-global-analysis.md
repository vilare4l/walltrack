...
- [ ] Create StrategyStats dataclass
- [ ] Create GlobalAnalysisResult dataclass
- [ ] Implement GlobalAnalyzer class
- [ ] Implement get_positions_with_history()
- [ ] Implement analyze() with progress
- [ ] Add cancellation support
- [ ] Add result caching
- [ ] Build UI component
- [ ] Add apply as default functionality
- [ ] Write tests

## Definition of Done

- [ ] Analysis runs on selected period
- [ ] Progress bar updates
- [ ] Results show all strategies
- [ ] Best strategy highlighted
- [ ] Apply as default works
- [ ] Cancellation works
