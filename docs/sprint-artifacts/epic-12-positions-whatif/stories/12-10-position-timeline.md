...
- [ ] Create PositionEventType enum
- [ ] Create PositionEvent dataclass
- [ ] Create PositionTimeline dataclass
- [ ] Implement PositionTimelineService
- [ ] Implement log_event() method
- [ ] Implement get_timeline() with filtering
- [ ] Implement export_timeline() for JSON/CSV
- [ ] Create timeline UI component
- [ ] Add event type display configuration
- [ ] Format timeline as markdown
- [ ] Format timeline as dataframe
- [ ] Add filter controls
...
- [ ] Filtering works by event type
- [ ] Export works in JSON and CSV
- [ ] UI shows event details
- [ ] Tests pass
