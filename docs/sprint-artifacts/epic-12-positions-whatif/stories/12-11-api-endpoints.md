...
- [ ] Implement GET /api/positions/{id} endpoint
- [ ] Implement PATCH /api/positions/{id}/strategy endpoint
- [ ] Implement POST /api/positions/{id}/simulate endpoint
- [ ] Implement GET /api/positions/{id}/timeline endpoint
- [ ] Implement timeline export endpoint
- [ ] Implement POST /api/analysis/global endpoint
- [ ] Implement GET /api/analysis/positions/{id}/compare-all endpoint
