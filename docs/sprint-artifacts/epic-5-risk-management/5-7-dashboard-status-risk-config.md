...
- [ ] Display system state and health indicators
- [ ] Create risk config panel with all parameters
- [ ] Implement parameter validation
- [ ] Add health warning indicators
- [ ] Implement no-signal warning
- [ ] Log all config changes

## Definition of Done

- [ ] System status displayed accurately
- [ ] Risk parameters viewable and editable
