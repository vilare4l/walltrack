...
- [ ] Create `src/walltrack/ui/components/alerts.py`
- [ ] Implement alert creation on circuit breaker trigger
- [ ] Create dashboard alerts panel
...
- [ ] Alerts created on circuit breaker triggers
- [ ] Dashboard alerts panel shows all alerts
- [ ] Alerts can be acknowledged
- [ ] System errors create alerts
