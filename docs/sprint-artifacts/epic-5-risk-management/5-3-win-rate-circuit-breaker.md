...
- [ ] Implement rolling window win rate calculation
- [ ] Trigger circuit breaker on threshold breach
- [ ] Change system status to "paused_win_rate"
- [ ] Handle insufficient trade history
- [ ] Require manual reset to resume
- [ ] Make window size and threshold configurable

## Definition of Done

- [ ] Win rate calculated over rolling window
