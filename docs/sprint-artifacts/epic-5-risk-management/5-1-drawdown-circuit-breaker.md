...
- [ ] Create `src/walltrack/core/risk/circuit_breaker.py`
- [ ] Implement drawdown calculation
- [ ] Track peak_capital
- [ ] Implement circuit breaker trigger
- [ ] Block new trades while keeping exits active
...
- [ ] New trades blocked, exits continue
